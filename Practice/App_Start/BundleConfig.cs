...
namespace Practice
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //jquery插件
            bundles.Add(new ScriptBundle("~/bundles/js/jquery/plugins")
                .Include("~/Scripts/jQueryPlugins/Datatables/jquery.dataTables.js"));

            //ace模板的js
            bundles.Add(new ScriptBundle("~/bundles/js/ace")
                .Include("~/css/ace/js/ace-extra.min.js",
                "~/css/ace/js/jquery-ui-1.10.3.full.min.js",
                "~/css/ace/js/date-time/bootstrap-datepicker.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/js/common")
                .Include("~/css/mystyle.js",
                    ...
                    "~/Packaging/datatables_tep.js",
                    "~/Packaging/jq_autocomplete_tep.js",
